...
Generated 2026-04-20T07:06:51.540Z · seed `villa-elast-v3` · 60 agents × 2 rate levels × 8 archetypes · elapsed 34.7s
...
| Mean absolute error (ε units) | 1.172 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 100% | 90% | -0.206 | -0.45 | [-0.6, -0.3] | 0.244 | ≈ within_tolerance |
| honeymooner | €750 | €1250 | 60% | 25% | -1.714 | -0.85 | [-1.1, -0.6] | 0.864 | ❌ fail |
| family_vacationer | €525 | €875 | 93.3% | 8.3% | -4.737 | -1.008 | [-1.25, -0.8] | 3.729 | ❌ fail |
| business_traveler | €375 | €625 | 45% | 25% | -1.151 | -0.7 | [-0.9, -0.5] | 0.451 | ❌ fail |
| digital_nomad | €225 | €375 | 63.3% | 50% | -0.462 | -1.3 | [-1.55, -1.05] | 0.838 | ❌ fail |
| budget_optimizer | €150 | €250 | 96.7% | 56.7% | -1.045 | -1.57 | [-1.85, -1.3] | 0.525 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 63.3% | 28.3% | -1.576 | -0.55 | [-0.75, -0.35] | 1.026 | ❌ fail |
| event_attendee | €338 | €563 | 51.7% | 66.7% | 0.499 | -1.2 | [-1.45, -0.95] | 1.699 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=villa-elast-v3 N_PER_RATE=60 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-06-51-541Z.json`

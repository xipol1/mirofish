...
Generated 2026-04-20T07:11:19.242Z · seed `villa-elast-v5` · 80 agents × 2 rate levels × 8 archetypes · elapsed 47.7s
...
| Mean absolute error (ε units) | 0.705 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 36.3% | 27.5% | -0.543 | -0.45 | [-0.6, -0.3] | 0.093 | ✅ in_range |
| honeymooner | €750 | €1250 | 77.5% | 36.3% | -1.485 | -0.85 | [-1.1, -0.6] | 0.635 | ❌ fail |
| family_vacationer | €525 | €875 | 90% | 20% | -2.944 | -1.008 | [-1.25, -0.8] | 1.936 | ❌ fail |
| business_traveler | €375 | €625 | 73.8% | 83.8% | 0.249 | -0.7 | [-0.9, -0.5] | 0.949 | ❌ fail |
| digital_nomad | €225 | €375 | 70% | 25% | -2.016 | -1.3 | [-1.55, -1.05] | 0.716 | ❌ fail |
| budget_optimizer | €150 | €250 | 93.8% | 52.5% | -1.136 | -1.57 | [-1.85, -1.3] | 0.434 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 85% | 52.5% | -0.943 | -0.55 | [-0.75, -0.35] | 0.393 | ❌ fail |
| event_attendee | €338 | €563 | 28.8% | 20% | -0.715 | -1.2 | [-1.45, -0.95] | 0.485 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=villa-elast-v5 N_PER_RATE=80 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-11-19-243Z.json`

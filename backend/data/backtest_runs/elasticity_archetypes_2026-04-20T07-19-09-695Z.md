...
Generated 2026-04-20T07:19:09.693Z · seed `fam-full` · 40 agents × 2 rate levels × 8 archetypes · elapsed 24.2s
...
| Mean absolute error (ε units) | 1.028 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 42.5% | 17.5% | -1.737 | -0.45 | [-0.6, -0.3] | 1.287 | ❌ fail |
| honeymooner | €750 | €1250 | 87.5% | 25% | -2.452 | -0.85 | [-1.1, -0.6] | 1.602 | ❌ fail |
| family_vacationer | €525 | €875 | 0% | 0% | n/a | -1.008 | [-1.25, -0.8] | n/a | — no_anchor |
| business_traveler | €375 | €625 | 70% | 77.5% | 0.199 | -0.7 | [-0.9, -0.5] | 0.899 | ❌ fail |
| digital_nomad | €225 | €375 | 75% | 17.5% | -2.849 | -1.3 | [-1.55, -1.05] | 1.549 | ❌ fail |
| budget_optimizer | €150 | €250 | 97.5% | 52.5% | -1.212 | -1.57 | [-1.85, -1.3] | 0.358 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 90% | 50% | -1.151 | -0.55 | [-0.75, -0.35] | 0.601 | ❌ fail |
| event_attendee | €338 | €563 | 17.5% | 15% | -0.302 | -1.2 | [-1.45, -0.95] | 0.898 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=fam-full N_PER_RATE=40 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-19-09-695Z.json`

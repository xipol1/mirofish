...
**Verdict:** `DRIFT` · pass rate **12.5%** (1/8 archetypes)

Generated 2026-04-20T07:05:38.505Z · seed `villa-elast-v2` · 60 agents × 2 rate levels × 8 archetypes · elapsed 35.1s
...
| Strict in-range matches | 1 (12.5%) |
| Passes (in-range + within-tolerance) | 1 (12.5%) |
| Mean absolute error (ε units) | 1.25 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 96.7% | 25% | -2.648 | -0.45 | [-0.6, -0.3] | 2.198 | ❌ fail |
| honeymooner | €750 | €1250 | 98.3% | 71.7% | -0.618 | -0.85 | [-1.1, -0.6] | 0.232 | ✅ in_range |
| family_vacationer | €525 | €875 | 85% | 81.7% | -0.078 | -1.008 | [-1.25, -0.8] | 0.93 | ❌ fail |
| business_traveler | €375 | €625 | 85% | 36.7% | -1.644 | -0.7 | [-0.9, -0.5] | 0.944 | ❌ fail |
| digital_nomad | €225 | €375 | 50% | 100% | 1.357 | -1.3 | [-1.55, -1.05] | 2.657 | ❌ fail |
| budget_optimizer | €150 | €250 | 71.7% | 75% | 0.088 | -1.57 | [-1.85, -1.3] | 1.658 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 83.3% | 76.7% | -0.162 | -0.55 | [-0.75, -0.35] | 0.388 | ❌ fail |
| event_attendee | €338 | €563 | 86.7% | 28.3% | -2.194 | -1.2 | [-1.45, -0.95] | 0.994 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=villa-elast-v2 N_PER_RATE=60 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-05-38-506Z.json`

...
**Verdict:** `DRIFT` · pass rate **0%** (0/6 archetypes)

Generated 2026-04-20T07:03:16.757Z · seed `villa-elast-v1` · 40 agents × 2 rate levels × 8 archetypes · elapsed 22.2s
...
| Mean absolute error (ε units) | 2.613 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 27.5% | 0% | n/a | -0.45 | [-0.6, -0.3] | n/a | — no_anchor |
| honeymooner | €750 | €1250 | 65% | 5% | -5.021 | -0.85 | [-1.1, -0.6] | 4.171 | ❌ fail |
| family_vacationer | €525 | €875 | 80% | 22.5% | -2.483 | -1.008 | [-1.25, -0.8] | 1.475 | ❌ fail |
| business_traveler | €375 | €625 | 100% | 12.5% | -4.071 | -0.7 | [-0.9, -0.5] | 3.371 | ❌ fail |
| digital_nomad | €225 | €375 | 100% | 0% | n/a | -1.3 | [-1.55, -1.05] | n/a | — no_anchor |
| budget_optimizer | €150 | €250 | 100% | 12.5% | -4.071 | -1.57 | [-1.85, -1.3] | 2.501 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 97.5% | 52.5% | -1.212 | -0.55 | [-0.75, -0.35] | 0.662 | ❌ fail |
| event_attendee | €338 | €563 | 55% | 5% | -4.7 | -1.2 | [-1.45, -0.95] | 3.5 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=villa-elast-v1 N_PER_RATE=40 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-03-16-758Z.json`

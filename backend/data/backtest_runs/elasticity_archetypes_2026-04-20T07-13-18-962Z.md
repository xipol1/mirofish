...
Generated 2026-04-20T07:13:18.961Z · seed `villa-elast-v6` · 150 agents × 2 rate levels × 8 archetypes · elapsed 88.6s
...
| Mean absolute error (ε units) | 1.155 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 32.7% | 22% | -0.776 | -0.45 | [-0.6, -0.3] | 0.326 | ≈ within_tolerance |
| honeymooner | €750 | €1250 | 81.3% | 30.7% | -1.906 | -0.85 | [-1.1, -0.6] | 1.056 | ❌ fail |
| family_vacationer | €525 | €875 | 91.3% | 8.7% | -4.602 | -1.008 | [-1.25, -0.8] | 3.594 | ❌ fail |
| business_traveler | €375 | €625 | 76.7% | 75.3% | -0.036 | -0.7 | [-0.9, -0.5] | 0.664 | ❌ fail |
| digital_nomad | €225 | €375 | 76% | 26.7% | -2.048 | -1.3 | [-1.55, -1.05] | 0.748 | ❌ fail |
| budget_optimizer | €150 | €250 | 87.3% | 52.7% | -0.988 | -1.57 | [-1.85, -1.3] | 0.582 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 88% | 45.3% | -1.3 | -0.55 | [-0.75, -0.35] | 0.75 | ❌ fail |
| event_attendee | €338 | €563 | 22.7% | 26.7% | 0.318 | -1.2 | [-1.45, -0.95] | 1.518 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=villa-elast-v6 N_PER_RATE=150 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-13-18-962Z.json`

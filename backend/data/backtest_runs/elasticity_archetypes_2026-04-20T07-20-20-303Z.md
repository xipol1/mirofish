...
**Verdict:** `DRIFT` · pass rate **0%** (0/5 archetypes)

Generated 2026-04-20T07:20:20.302Z · seed `fam-stages` · 10 agents × 2 rate levels × 8 archetypes · elapsed 7.0s
...
| Metric | Value |
|---|---|
| Archetypes with benchmark anchor | 5 |
| Strict in-range matches | 0 (0%) |
| Passes (in-range + within-tolerance) | 0 (0%) |
| Mean absolute error (ε units) | 1.364 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 50% | 10% | -3.151 | -0.45 | [-0.6, -0.3] | 2.701 | ❌ fail |
| honeymooner | €750 | €1250 | 80% | 20% | -2.714 | -0.85 | [-1.1, -0.6] | 1.864 | ❌ fail |
| family_vacationer | €525 | €875 | 0% | 0% | n/a | -1.008 | [-1.25, -0.8] | n/a | — no_anchor |
| business_traveler | €375 | €625 | 80% | 70% | -0.261 | -0.7 | [-0.9, -0.5] | 0.439 | ❌ fail |
| digital_nomad | €225 | €375 | 70% | 0% | n/a | -1.3 | [-1.55, -1.05] | n/a | — no_anchor |
| budget_optimizer | €150 | €250 | 80% | 60% | -0.563 | -1.57 | [-1.85, -1.3] | 1.007 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 80% | 40% | -1.357 | -0.55 | [-0.75, -0.35] | 0.807 | ❌ fail |
| event_attendee | €338 | €563 | 0% | 20% | n/a | -1.2 | [-1.45, -0.95] | n/a | — no_anchor |
...
```bash
USE_SYNTH=true SEED=fam-stages N_PER_RATE=10 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-20-20-303Z.json`

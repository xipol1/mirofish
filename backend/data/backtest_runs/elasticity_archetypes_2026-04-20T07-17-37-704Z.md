...
Generated 2026-04-20T07:17:37.703Z · seed `debug-fam-decision` · 10 agents × 2 rate levels × 8 archetypes · elapsed 7.1s
...
| Mean absolute error (ε units) | 0.785 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 50% | 20% | -1.794 | -0.45 | [-0.6, -0.3] | 1.344 | ❌ fail |
...
| digital_nomad | €225 | €375 | 70% | 50% | -0.659 | -1.3 | [-1.55, -1.05] | 0.641 | ❌ fail |
| budget_optimizer | €150 | €250 | 100% | 70% | -0.698 | -1.57 | [-1.85, -1.3] | 0.872 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 80% | 70% | -0.261 | -0.55 | [-0.75, -0.35] | 0.289 | ≈ within_tolerance |
| event_attendee | €338 | €563 | 30% | 20% | -0.795 | -1.2 | [-1.45, -0.95] | 0.405 | ❌ fail |
...
Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-17-37-704Z.json`

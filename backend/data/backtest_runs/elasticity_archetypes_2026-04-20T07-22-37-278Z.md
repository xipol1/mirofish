...
**Verdict:** `DRIFT` · pass rate **33.3%** (2/6 archetypes)

Generated 2026-04-20T07:22:37.277Z · seed `fam-v7` · 10 agents × 2 rate levels × 8 archetypes · elapsed 6.9s
...
| Strict in-range matches | 1 (16.7%) |
| Passes (in-range + within-tolerance) | 2 (33.3%) |
| Mean absolute error (ε units) | 0.549 |
...
| honeymooner | €750 | €1250 | 50% | 20% | -1.794 | -0.85 | [-1.1, -0.6] | 0.944 | ❌ fail |
| family_vacationer | €525 | €875 | 100% | 0% | n/a | -1.008 | [-1.25, -0.8] | n/a | — no_anchor |
| business_traveler | €375 | €625 | 90% | 80% | -0.231 | -0.7 | [-0.9, -0.5] | 0.469 | ❌ fail |
| digital_nomad | €225 | €375 | 70% | 0% | n/a | -1.3 | [-1.55, -1.05] | n/a | — no_anchor |
| budget_optimizer | €150 | €250 | 100% | 60% | -1 | -1.57 | [-1.85, -1.3] | 0.57 | ❌ fail |
| loyalty_maximizer | €450 | €750 | 80% | 60% | -0.563 | -0.55 | [-0.75, -0.35] | 0.013 | ✅ in_range |
| event_attendee | €338 | €563 | 30% | 10% | -2.153 | -1.2 | [-1.45, -0.95] | 0.953 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=fam-v7 N_PER_RATE=10 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-22-37-278Z.json`

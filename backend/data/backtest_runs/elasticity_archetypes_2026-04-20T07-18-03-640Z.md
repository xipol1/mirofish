...
**Verdict:** `PARTIAL_MATCH` · pass rate **57.1%** (4/7 archetypes)

Generated 2026-04-20T07:18:03.639Z · seed `fam-dec2` · 10 agents × 2 rate levels × 8 archetypes · elapsed 7.0s
...
| Strict in-range matches | 3 (42.9%) |
| Passes (in-range + within-tolerance) | 4 (57.1%) |
| Mean absolute error (ε units) | 0.838 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 60% | 10% | -3.508 | -0.45 | [-0.6, -0.3] | 3.058 | ❌ fail |
...
| digital_nomad | €225 | €375 | 80% | 40% | -1.357 | -1.3 | [-1.55, -1.05] | 0.057 | ✅ in_range |
| budget_optimizer | €150 | €250 | 100% | 40% | -1.794 | -1.57 | [-1.85, -1.3] | 0.224 | ✅ in_range |
| loyalty_maximizer | €450 | €750 | 70% | 60% | -0.302 | -0.55 | [-0.75, -0.35] | 0.248 | ≈ within_tolerance |
| event_attendee | €338 | €563 | 40% | 50% | 0.437 | -1.2 | [-1.45, -0.95] | 1.637 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=fam-dec2 N_PER_RATE=10 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-18-03-640Z.json`

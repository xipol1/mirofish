...
Generated 2026-04-20T07:16:34.262Z · seed `debug-fam` · 10 agents × 2 rate levels × 8 archetypes · elapsed 7.1s
...
| Mean absolute error (ε units) | 1.282 |
...
|---|---|---|---|---|---|---|---|---|---|
| luxury_seeker | €900 | €1500 | 80% | 10% | -4.071 | -0.45 | [-0.6, -0.3] | 3.621 | ❌ fail |
| honeymooner | €750 | €1250 | 100% | 50% | -1.357 | -0.85 | [-1.1, -0.6] | 0.507 | ❌ fail |
| family_vacationer | €525 | €875 | 90% | 30% | -2.151 | -1.008 | [-1.25, -0.8] | 1.143 | ❌ fail |
| business_traveler | €375 | €625 | 70% | 70% | 0 | -0.7 | [-0.9, -0.5] | 0.7 | ❌ fail |
| digital_nomad | €225 | €375 | 60% | 50% | -0.357 | -1.3 | [-1.55, -1.05] | 0.943 | ❌ fail |
| budget_optimizer | €150 | €250 | 80% | 30% | -1.92 | -1.57 | [-1.85, -1.3] | 0.35 | ≈ within_tolerance |
| loyalty_maximizer | €450 | €750 | 90% | 40% | -1.587 | -0.55 | [-0.75, -0.35] | 1.037 | ❌ fail |
| event_attendee | €338 | €563 | 50% | 10% | -3.154 | -1.2 | [-1.45, -0.95] | 1.954 | ❌ fail |
...
```bash
USE_SYNTH=true SEED=debug-fam N_PER_RATE=10 \
  node scripts/elasticity_backtest_archetypes.js
```

Machine-readable: `backend\data\backtest_runs\elasticity_archetypes_2026-04-20T07-16-34-263Z.json`

 ...
 */
function runScenario({ scenario_id, custom = null, baseline, cohort_size = 50 }) {
  ...
  const eff = scenario.computed_effects(ctx);
  ...
  return {
    ...
    auditability: 'Each coefficient sourced from Cornell HQ / Kahneman & Tversky / Kimes 2011; see _research_sources in ops_incident_rates.json for methodology.',
  };
}

/**
 * Scenario Editor — consultant-facing pre-decision workbench.
 *
 * Principle: the decision is the product. Everything else is context. A
...
const CALIBRATION_PROVENANCE = {
  ...
  cluster_book_delta: {
    ...
    french:            { tag: 'expert-inference', label: 'Expert default' },
    latin_spain_italy: { tag: 'EGATUR-anchored',  label: 'INE EGATUR 2024' },
    nordic:            { tag: 'expert-inference', label: 'Expert default' },
    latin_american:    { tag: 'EGATUR-anchored',  label: 'INE EGATUR 2024' },
    middle_east_gcc:   { tag: 'EGATUR-anchored',  label: 'INE EGATUR 2024' },
    east_asian:        { tag: 'expert-inference', label: 'Expert default' },
    chinese_mainland:  { tag: 'expert-inference', label: 'Expert default' },
  },
};
  ...
  return (
    <div className="print-only" style={{ background: 'white', color: '#1a1d23', padding: '20mm 18mm' }}>
      ...
      <div style={{ fontSize: 9, color: '#9ca3af', borderTop: '1px solid #e5e7eb', paddingTop: 8 }}>
        Generated by the Synthetic Users Pre-decision Workbench{hostname ? ` (${hostname})` : ''}.
